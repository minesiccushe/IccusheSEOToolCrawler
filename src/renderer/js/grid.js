...
export function initGrid(containerSelector) {
  table = new Tabulator(containerSelector, {
    ...
    columns: [
      ...
      // Heading Structure Columns
      { title: "H1 Count", field: "h1Count", width: 100, visible: false, hozAlign: "right" },
      { title: "H2 Count", field: "h2Count", width: 100, visible: false, hozAlign: "right" },
      { title: "H3 Count", field: "h3Count", width: 100, visible: false, hozAlign: "right" },
      { title: "H4 Count", field: "h4Count", width: 100, visible: false, hozAlign: "right" },
      { title: "H5 Count", field: "h5Count", width: 100, visible: false, hozAlign: "right" },
      { title: "H6 Count", field: "h6Count", width: 100, visible: false, hozAlign: "right" },
      { title: "H1 Texts", field: "h1Texts", width: 200, visible: false },
      { title: "H2 Texts", field: "h2Texts", width: 200, visible: false },
      { title: "H3 Texts", field: "h3Texts", width: 200, visible: false },
      { title: "Has Multiple H1", field: "hasMultipleH1", width: 130, visible: false, formatter: "tickCross" },
      { title: "Missing H1", field: "missingH1", width: 100, visible: false, formatter: "tickCross" },
      { title: "Heading Order Valid", field: "headingOrderValid", width: 150, visible: false, formatter: "tickCross" },
      { title: "Heading Hierarchy Issues", field: "headingHierarchyIssues", width: 200, visible: false },
      { title: "First H1 Text", field: "firstH1Text", width: 200, visible: false },
      { title: "Longest Heading Length", field: "longestHeadingTextLength", width: 150, visible: false, hozAlign: "right" },
      { title: "Empty Heading Count", field: "emptyHeadingCount", width: 150, visible: false, hozAlign: "right" },
